<template>
    <div id="layout-header" :class="{'fixed':fixed,'hidden':hidden}">
        <div class="site-logo">
            <router-link to="/">
                <img src="https://www.hot7zzz.cn/wp-content/uploads/2024/09/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20240908040437-1024x590.jpg" alt="" style="width: 50px;height: 50px; border-radius: 10px;">
                <p class="site-name">Hot7s</p>
            </router-link>
        </div>
